...
then
    ...
    mkdir -p ${PACKAGE_DIR}/usr/share/abevjava/eroforrasok

    echo "[.] Moving files ..."
    cp -n ${ADDITIONAL_PATH}/abevjava-resource/eroforrasok/* ${PACKAGE_DIR}/usr/share/abevjava/eroforrasok/     > /dev/null
