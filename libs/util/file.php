...
class File {
   ...
   * @param directory $path         - Path to directory
  ...
  public static function PackageName($FullPathFilename, $PackageType) {
    $path_parts = pathinfo($FullPathFilename);
    switch ($PackageType) {
      case "1": return( $path_parts['filename'] );
	break;
      case "2": return( 'abev-form-' . $path_parts['filename'] );
	break;
      case "3": return( 'abev-form-' . $path_parts['filename'] . '-doc' );
	break;
      case "4": return( $path_parts['filename'] );
	break;
      case "2147483647": return( $path_parts['filename'] );
	break;
  ...
  public static function PackageNameWithExtension($FullPathFilename, $PackageType) {
    $path_parts = pathinfo($FullPathFilename);
    switch ($PackageType) {
      case "1": return( $path_parts['filename'] . '.' . $path_parts['extension'] );
	break;
      case "2": return( 'abev-form-' . $path_parts['filename'] . '.' . $path_parts['extension'] );
	break;
      case "3": return( 'abev-form-' . $path_parts['filename'] . '-doc' . '.' . $path_parts['extension'] );
	break;
      case "4": return( $path_parts['filename'] . '.' . $path_parts['extension'] );
	break;
      case "2147483647": return( $path_parts['filename'] . '.' . $path_parts['extension'] );
	break;
  ...
  public static function PackageNameWithVersionPlatform($FullPathFilename, $Major, $Minor, $Micro, $Build, $Packing = 0, $PackageType) {
    $path_parts = pathinfo($FullPathFilename);
    switch ($PackageType) {
      case "1": return( $path_parts['filename'] . '-' . $Major . '.' . $Minor . '.' . $Micro . '.' . $Build . '-' . $Packing . '_all.' . $path_parts['extension'] );
	break;
      case "2": return( 'abev-form-' . $path_parts['filename'] . '-' . $Major . '.' . $Minor . '.' . $Micro . '.' . $Build . '-' . $Packing . '_all.' . $path_parts['extension'] );
	break;
      case "3": return( 'abev-form-' . $path_parts['filename'] . '-' . $Major . '.' . $Minor . '.' . $Micro . '.' . $Build . '-' . $Packing . '-doc_all.' . $path_parts['extension'] );
	break;
      case "4": return( $path_parts['filename'] . '-' . $Major . '.' . $Minor . '.' . $Micro . '.' . $Build . '-' . $Packing . '_all.' . $path_parts['extension'] );
	break;
      case "2147483647": return( $path_parts['filename'] . '-' . $Major . '.' . $Minor . '.' . $Micro . '.' . $Build . '-' . $Packing . '_all.' . $path_parts['extension'] );
	break;
